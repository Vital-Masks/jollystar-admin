...
const AddNewMember = () => {
    ...
    const [formValues, setFormValues] = useState({
        ...
        schoolDetails: [{ schoolName: '', participated: '', game: '', from: '', to: '', role: '' }],
        clubDetails: [{ clubName: '', involved: '', game: '', from: '', to: '', role: '' }],
        paymentDetails: [{ category: '', bank: '', branch: '', total: '', date: '', paymentImage: '' }],
    });
                            ...
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <input id="profession" type="date" placeholder="Web Developer" className="form-input rounded-full border-dark" required />
                                    </div>
                                    
                                    <div>
                                        <label htmlFor="address">NIC/Passport Id</label>
                                        <input id="address" type="text" placeholder="New York" className="form-input rounded-full border-dark" required />
                                    </div>
                                    <div>
                                        <label htmlFor="email">Email</label>
                                        <input id="email" type="email" placeholder="Jimmy@gmail.com" className="form-input rounded-full border-dark" required />
                                    </div>
                                    <div>
                                        <label htmlFor="phone">Mobile Number</label>
                                        <input id="phone" type="tel" placeholder="+1 (530) 555-12121" className="form-input rounded-full border-dark" required />
                                    </div>
                                    <div>
                                        <label htmlFor="phone">Telephone Number</label>
                                        <input id="phone" type="text" placeholder="+1 (530) 555-12121" className="form-input rounded-full border-dark" required />
                                    </div>
                                    <div>
                                        <label htmlFor="location">Resident Address</label>
                                        <input id="location" type="text" placeholder="Location" className="form-input rounded-full border-dark" required />
                                    </div>
                                    <div>
                                        <label htmlFor="web">Marital Status</label>
                                        <input id="web" type="text" placeholder="Enter URL" className="form-input rounded-full border-dark" required />
                                    </div>
                                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row">
                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-5">
                                <div>
                                    ...
                                    <input id="profession" type="text" placeholder="Web Developer" className="form-input rounded-full border-dark" required />
                                </div>
                                <div>
