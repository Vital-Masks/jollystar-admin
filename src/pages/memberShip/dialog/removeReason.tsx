...
interface RemoveMemberReasonProps {
    hableRemove: (reason: string) => void;
    removeLoading: boolean;
}

const RemoveMemberReason = ({ hableRemove, removeLoading }: RemoveMemberReasonProps) => {
    ...
    return (
        <div>
            <div className="flex mt-5 ml-5 justify-center">
                <button onClick={() => setAddReasonModal(true)} type="button" className="btn btn-outline-danger rounded-full text-2xl">
...
export default RemoveMemberReason;
