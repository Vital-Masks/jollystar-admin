...
const Posts = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://api.jollystars.lk/api/newsManagement/getAllNews');
    ...
    const postData = async (data: any) => {
        setPostLoading(true)
        try {
            const response = await axios.post('https://api.jollystars.lk/api/newsManagement', data).then((res) => {
                fetchData()
            })
    ...
    const putData = async (data: any) => {
        setPostLoading(true)
        try {
            const response = await axios.put('https://api.jollystars.lk/api/newsManagement/' + data._id, data).then((res) => {
                fetchData()
            })
    ...
    const deletePostsData = async (data: any) => {
        try {
            const response = await fetch(`https://api.jollystars.lk/api/newsManagement/${data._id}`, {
                method: 'DELETE',
                headers: {
